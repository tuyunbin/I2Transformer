...
def main():
    parser = argparse.ArgumentParser(description="translate2.py")

    parser.add_argument("-eval_split_name", default='val', choices=["val", "test_public"])
    parser.add_argument("-eval_path", type=str, default='data/tvc_val_release.jsonl',help="Path to eval data")
    parser.add_argument("-reference_path", type=str, default=None, help="Path to reference")
    parser.add_argument("-res_dir", default="/baselines/multimodal_transformer/results/", help="path to dir containing model .pt file")
