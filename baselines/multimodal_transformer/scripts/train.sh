...
if [[ ${vid_feat_type} == "i3d" ]]; then
    ...
    echo "Using ResNet feature with shape 2048 and I3D feature with shape 1024"
    res_vid_feat_path=${feature_root}/video_feature/tvr_resnet152_rgb_max_cl-1.5.h5
    res_vid_feat_size=2048
    i3d_vid_feat_path=${feature_root}/video_feature/tvr_i3d_rgb600_avg_cl-1.5.h5
    i3d_vid_feat_size=1024
...
-res_vid_feat_path ${res_vid_feat_path} \
-res_vid_feat_size ${res_vid_feat_size} \
-i3d_vid_feat_path ${i3d_vid_feat_path} \
-i3d_vid_feat_size ${i3d_vid_feat_size} \
