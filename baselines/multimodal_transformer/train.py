...
def get_args():
    ...
    parser.add_argument("-res_vid_feat_size", type=int, default=2048, help="2048 appearance + 1024 flow")
    parser.add_argument("-i3d_vid_feat_size", type=int, default=1024, help="2048 appearance + 1024 flow")
    parser.add_argument("-max_v_len", type=int, default=20, help="max length of video feature")
    parser.add_argument("-max_sub_len", type=int, default=30, help="max number of words in subtitle")
    ...
    parser.add_argument("-train_path", type=str, default='/data/tvc_train_release.jsonl', help="path to the training data")
    parser.add_argument("-eval_path", type=str, default='data/tvc_val_release.jsonl', help="path to the eval data")
    parser.add_argument("-data_ratio", type=float, default=1, help="how many train/eval data to use")
    parser.add_argument("-reference_path", type=str,)
    parser.add_argument("-sub_meta_path", type=str, default='/data/tvqa_preprocessed_subtitles.jsonl', help="path to")
    parser.add_argument("-res_vid_feat_path", type=str, default="/data/tvc_feature_release/video_feature/tvr_resnet152_rgb_max_cl-1.5.h5", help="path to video features")
    parser.add_argument("-i3d_vid_feat_path", type=str,
                        default= "/data/tvc_feature_release/video_feature/tvr_i3d_rgb600_avg_cl-1.5.h5",
    ...
    parser.add_argument("-word2idx_path", type=str, default="./cache/tvc_word2idx.json")
    ...
    if opt.res_vid_feat_size > 3000:  # 3072, the normalized concatenation of resnet+i3d
...
def main():
    ...
    train_dataset = TVCaptionDataset(
        ...
        res_vid_h5_path_or_handler=opt.res_vid_feat_path,
        i3d_vid_h5_path_or_handler=opt.i3d_vid_feat_path,
    ...
    eval_dataset = TVCaptionDataset(
        ...
        sub_meta_path=opt.sub_meta_path,
        res_vid_h5_path_or_handler=train_dataset.res_vid_h5 if "video" in opt.ctx_mode else None,
        i3d_vid_h5_path_or_handler=train_dataset.i3d_vid_h5 if "video" in opt.ctx_mode else None,
        word2idx_path=opt.word2idx_path,
        max_cap_len=opt.max_cap_len,
        max_sub_len=opt.max_sub_len,
        max_v_len=opt.max_v_len,
    ...
    rt_config = EDict(
        ...
        res_video_feature_size=opt.res_vid_feat_size,
        i3d_video_feature_size=opt.i3d_vid_feat_size,
